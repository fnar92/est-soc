    ...
    public function index() {
        ...
        foreach ($estudios as $estudio) {
            ...
            foreach ($hijos as $hijo) {
                $sql="insert into hijo_familia(id_familia, id_estudio, folio_estudio, nombre, apellido_paterno, apellido_materno, edad, correo_electronico, nivel_grado_cursar, institucion, colegiatura_pasado, colegiatura_actual, beca_actual, fuente_apoyo, apoyo_solicitado, status, comentarios, otras_colegiaturas) values ('$idFamilia', '$idEstudio', '$hijo->folio_estudio', '$hijo->nombre','$hijo->apellido_paterno', '$hijo->apellido_materno','$hijo->edad', '$hijo->correo_electronico', '$hijo->nivel_grado_cursar', '$hijo->institucion', '$hijo->colegiatura_pasado', '$hijo->colegiatura_actual','$hijo->beca_actual', '$hijo->fuente_apoyo', '$hijo->apoyo_solicitado', '$hijo->status', '$hijo->comentarios', '$hijo->otras_colegiaturas'); \n";
                $return.=$sql;
            }
            $return.= "\n";
